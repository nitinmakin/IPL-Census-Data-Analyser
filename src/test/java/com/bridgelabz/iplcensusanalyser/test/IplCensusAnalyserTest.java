...
public class IplCensusAnalyserTest {
    ...
    public void IplBattingDataShouldReturnCorrectRecords() {
        try {
            ...
            int numOfEntries = iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BATTING_DATA, IPL_BATTING_FILE_PATH);
    ...
    public void IplBowlingDataShouldReturnCorrectRecords() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            int numOfEntries = iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BOWLING_DATA, IPL_BOWLING_FILE_PATH);
    ...
    public void givenIplBestBattingAvgDataShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BATTING_DATA, IPL_BATTING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.TOP_BAT_AVG);
    ...
    public void givenIplBestBattingSRDataShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BATTING_DATA, IPL_BATTING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.TOP_BAT_SR);
            IplBattingCsv censusCsv[] = new Gson().fromJson(sortedCensusData, IplBattingCsv[].class);
    ...
    public void givenIplHighestBoundariesDataShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BATTING_DATA, IPL_BATTING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.MAX_6s_4s);
            IplBattingCsv censusCsv[] = new Gson().fromJson(sortedCensusData, IplBattingCsv[].class);
            Assert.assertEquals("Andre Russell", censusCsv[0].playerName);
            System.out.println(censusCsv[0]);
        } catch (IplAnalyserException e) {
    ...
    public void givenIplBestAvgWithBestSrShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BATTING_DATA, IPL_BATTING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.TOP_BAT_AVG_WITH_BEST_SR);
            IplBattingCsv censusCsv[] = new Gson().fromJson(sortedCensusData, IplBattingCsv[].class);
            Assert.assertEquals("Andre Russell", censusCsv[0].playerName);
            System.out.println(censusCsv[0]);
        } catch (IplAnalyserException e) {
    ...
    public void givenIplPlayerWithBestRunsShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BATTING_DATA, IPL_BATTING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.TOP_RUNS_OF_PLAYER);
            IplBattingCsv censusCsv[] = new Gson().fromJson(sortedCensusData, IplBattingCsv[].class);
    ...
    public void givenIplPlayerWithBestBowlingAvgShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BOWLING_DATA, IPL_BOWLING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.BEST_BOWL_AVG);
    ...
    public void givenIplPlayerWithBestBowlingSRShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BOWLING_DATA, IPL_BOWLING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.BEST_BOWL_SR);
            IplBowlingCsv censusCsv[] = new Gson().fromJson(sortedCensusData, IplBowlingCsv[].class);
    ...
    public void givenIplPlayerWithBestBowlingEconRateShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BOWLING_DATA, IPL_BOWLING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.BEST_BOWL_ECON);
            IplBowlingCsv censusCsv[] = new Gson().fromJson(sortedCensusData, IplBowlingCsv[].class);
    ...
    public void givenIplPlayerWithBest_4W_5W_EconRateShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BOWLING_DATA, IPL_BOWLING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.BEST_BOWL_4W_5W);
            IplBowlingCsv censusCsv[] = new Gson().fromJson(sortedCensusData, IplBowlingCsv[].class);
    ...
    public void givenIplPlayerWithBest_BowlAvg_BowlSr_EconRateShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BOWLING_DATA, IPL_BOWLING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.BEST_BOWL_AVG_AND_BEST_SR);
            IplBowlingCsv censusCsv[] = new Gson().fromJson(sortedCensusData, IplBowlingCsv[].class);
            Assert.assertEquals("Anukul Roy", censusCsv[0].playerName);
            System.out.println(censusCsv[0]);
        } catch (IplAnalyserException e) {
    ...
    public void givenIplPlayerWithHighestWicketsShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BATTING_DATA, IPL_BOWLING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.HIGHEST_WICKETS);
            IplBowlingCsv censusCsv[] = new Gson().fromJson(sortedCensusData, IplBowlingCsv[].class);
    ...
    public void givenIplPlayerWithMax100ShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BATTING_DATA, IPL_BATTING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.MAX100);
            IplBattingCsv censusCsv[] = new Gson().fromJson(sortedCensusData, IplBattingCsv[].class);
            Assert.assertEquals("David Warner ", censusCsv[0].playerName);
            System.out.println(censusCsv[0]);
        } catch (IplAnalyserException e) {
    ...
    public void givenIplPlayerWithMax50ShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BATTING_DATA, IPL_BATTING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.MAX50);
            IplBattingCsv censusCsv[] = new Gson().fromJson(sortedCensusData, IplBattingCsv[].class);
            Assert.assertEquals("David Warner ", censusCsv[0].playerName);
            System.out.println(censusCsv[0]);
        } catch (IplAnalyserException e) {
    ...
    public void givenIplPlayerWithZero50sAndZero100sShouldReturnCorrectResult() {
        try {
            IplCensusAnalyser iplCensusAnalyser = new IplCensusAnalyser();
            iplCensusAnalyser.LoadIplData(IplCensusAnalyser.IPL.BATTING_DATA, IPL_BATTING_FILE_PATH);
            String sortedCensusData = iplCensusAnalyser.getIplSortedData(EnumSort.ZERO50s_ZERO100s);
            IplBattingCsv censusCsv[] = new Gson().fromJson(sortedCensusData, IplBattingCsv[].class);
